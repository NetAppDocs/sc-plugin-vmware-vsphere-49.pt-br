...
+
Primeiro, você deve adicionar o sistema de storage vVols às ferramentas do ONTAP para VMware vSphere e adicioná-lo ao plug-in do SnapCenter para VMware vSphere.
