...
+
Não use os seguintes caracteres especiais em nomes de VM, armazenamento de dados, política, backup ou grupo de recursos: & * $ # @ ! \ / : * ?  " < > - | ; ' e espaço. Um caractere de sublinhado (_) é permitido.
